...
public class NewFilesMain {
    ...
    public static void main(String[] args) throws IOException {
        // 파일이나, 디렉토리의 경로는 Path 클래스를 사용해야 한다.
        ...
        // 5. isRegularFile(): 일반 파일인지 확인 ( 파일인지 아닌지 )
        ...
        Path newFile = Paths.get("temp/newExample.txt"); // 참고) Path 를 쓰는 방법이 두가지(Path.of(), Paths.get())가 있는데, Paths.get()은 약간 옛날 방식이다.
